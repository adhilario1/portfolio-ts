...
const Games = ({breakpoint}: Props) => {
    ...
    return (
        ...
        <iframe frameBorder="0" src="https://itch.io/embed-upload/9895434?color=333333"  width="640" height="724" allow="cross-origin-isolation"><a href="https://billyshouse.itch.io/tetris-clone">Play Tetris Clone on itch.io</a></iframe>
        </div>
        </>
