...
const Games = ({breakpoint}: Props) => {
    ...
    return (
        ...
        <div className="content games">
            ...
            <iframe frameBorder="0" src="https://itch.io/embed-upload/9913708?color=333333" allowfullscreen="" width="640" height="724"><a href="https://billyshouse.itch.io/tetris-clone">Play Tetris Clone on itch.io</a></iframe>
        </div>
        </>
